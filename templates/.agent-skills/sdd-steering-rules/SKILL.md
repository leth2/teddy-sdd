...
1. 해당 항목 제거
2. What-only 요약으로 대체
3. 상세 내용이 필요하면 `.agent-skills/<topic>-detail.md`로 이동
...
신규 생성 시 아래 템플릿을 읽고 `.sdd/steering/<type>/SKILL.md`로 작성:

→ `references/steering-product-template.md` — 제품 목적·기능·제약
→ `references/steering-tech-template.md` — 기술 스택·결정·제약
→ `references/steering-structure-template.md` — 폴더 구조·네이밍·모듈 경계
