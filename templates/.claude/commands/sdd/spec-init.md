...
Read `.agent-skills/sdd-workflow/SKILL.md` to understand the SDD workflow, then read `.sdd/settings/templates/specs/init.json` and `.sdd/settings/templates/specs/requirements.md`.
